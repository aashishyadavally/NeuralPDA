...
Pre-trained DeepPDA model weights (w/o statement types): [link](https://drive.google.com/drive/folders/1mIdQU7wvihsLbMFQStB8YxlS3OA0LKGV?usp=share_link)


## Getting Started with DeepPDA
### Run Instructions
